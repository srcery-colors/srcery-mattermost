...
1. Open the cogwheel in the upper right corner
1. Click **Display** on the sidebar to the right
1. Open **Theme** on the page that opens
1. Click **Custom Theme**
1. Paste the code from [`srcery.json`](./srcery.json) into the box that already have some JSON data

### Result

![applied theme](./assets/apply_scheme.png)
